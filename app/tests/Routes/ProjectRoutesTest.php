...
class ProjectRoutesTest extends TestCase{
    ...
    public function tesEditProjectByIdRoute(){
        $this->call('GET', 'projects/{projects}/edit', array('projects' => 1));
